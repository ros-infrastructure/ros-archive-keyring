Name:           ros2-testing-release
Version:        1.0.0
Summary:        Packages for ROS 2 testing repository configuration
...
Source20:       ros2-testing.repo


 
%description
This package contains the ROS 2 testing repository configuration and GPG key.
